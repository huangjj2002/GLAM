...
DATA_BASE_DIR = '/mnt/f'  # Path to your data folder
DATA_BASE_DIR = os.path.expanduser(DATA_BASE_DIR)
MY_API_TOKEN = "<replace-with-your-hf-api-token>" # Hugging Face API token
...
# #############################################
# RSNA Mammo constants
# #############################################
RSNA_MAMMO_DATA_PATH = DATA_BASE_DIR + "/new_embed_data"
RSNA_MAMMO_JPEG_DIR = RSNA_MAMMO_DATA_PATH + "/images_jpg"
RSNA_MAMMO_TRAIN_CSV = RSNA_MAMMO_DATA_PATH + '/embed_data.csv'
RSNA_MAMMO_TEST_CSV = RSNA_MAMMO_DATA_PATH + '/embed_data.csv'
